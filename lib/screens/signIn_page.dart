          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                  ...
                  onPressed: () async{
                    var check = await dbHelper.addnewuser(userModal(uemail: emailcontroller.text, uid:0, uname: namecontroller.text, upass: paswrdcontroller.text));
                    if(check){
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("already account created,  "), action: SnackBarAction( label: "log in", onPressed:(){Navigator.pushReplacement(context, MaterialPageRoute(builder: (c)=>login_page()));}),));
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                      ...
                      child: Text("login  instead", style: TextStyle(color:Color(0xffE86A53) ),))
                ],
              )
